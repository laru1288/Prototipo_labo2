...
Nivel_4::Nivel_4() {
	...
	_avatar_enemigo.loadFromFile("imagenes/FondosPelea/Avatar_balrog.png");
	...
	life_enemy.reallife = 8000;
	life_personaje.reallife = 7400;
...
void Nivel_4::seleccionar_elemento() {

	_elemento.cmd();

}

void Nivel_4::seleccionar_elemento_aleatorio() {
...
void Nivel_4::cargar_textura(std::string archivo) {
	_fondos.loadFromFile(archivo);


}

void Nivel_4::cargar_sprite_fondo() {
	_fondo.setTexture(_fondos);
	_fondo.setScale(2, 2);
}

void Nivel_4::turno_pj() {
	_dibujar_ataque_pj = false;
...
void Nivel_4::turno_enemigo() {
	...
	case 4:if (_elemento.getelemento() == 2) {
		...
		sound_4_enemy.play();
		  ...
		  break;
	case 5:if (_elemento.getelemento() == 1) {
		_danio = ataque_dragones * 2;
		sound_5_enemy.play();
	}
		  else {
		_danio = ataque_dragones;
		sound_5_enemy.play();
	}
		  break;
	case 6:if (_elemento.getelemento() == 3) {
...
bool Nivel_4::dibujar_elemento() {

	return _dibujar_elemento;
}

bool Nivel_4::dibujar_dado() {
	return _dibujar_dado;
}

bool Nivel_4::dibujar_ataque_pj() {
	return _dibujar_ataque_pj;
}

bool Nivel_4::dibujar_ataque_enemy() {
	return _dibujar_ataque_enemy;
}
sf::Sprite& Nivel_4::get_draw_fondo() { return _fondo; }

sf::Sprite& Nivel_4::get_draw_avatar_pj() { return _pj; }

sf::Sprite& Nivel_4::get_draw_avatar_enemigo() { return _enemigo; }

sf::Sprite& Nivel_4::get_draw_papiro() { return _papiro; }

sf::Sprite& Nivel_4::get_draw_pj() { return _PJ.get_draw_pj(); }

sf::Sprite& Nivel_4::get_draw_enemy() { return _enemies->getdraw(); }

sf::Sprite& Nivel_4::get_draw_life_enemy() { return life_enemy.getdraw(); }

sf::Sprite& Nivel_4::get_draw_life_pj() { return life_personaje.getdraw(); }

sf::Sprite& Nivel_4::get_draw_elemento() { return _elemento.getdraw(); }

sf::Sprite& Nivel_4::get_draw_dado() { return _dado.getdraw(); }

sf::Sprite& Nivel_4::get_draw_ataque_pj() { return _Ataque.getdraw_ataque_pj(); }

sf::Sprite& Nivel_4::get_draw_ataque_enemy() { return _Ataque.getdraw_ataque_en(); }

void Nivel_4::restaurar_elemento() {
...
void Nivel_4::createObject(int nivel) {
...
void Nivel_4::setDeltatime(float deltatime) {
	_deltatime = deltatime;
}

void Nivel_4::cargar_sonidos_enemigos(){
	atack_1_buf.loadFromFile("sonidos/enemigos/balrog/golpe.ogg");
	atack_2_buf.loadFromFile("sonidos/enemigos/balrog/wou.ogg");
	atack_3_buf.loadFromFile("sonidos/enemigos/balrog/zalasor.ogg");
	atack_4_buf.loadFromFile("sonidos/enemigos/balrog/zas.ogg");
	atack_5_buf.loadFromFile("sonidos/enemigos/balrog/piedrazo.ogg");
	atack_6_buf.loadFromFile("sonidos/enemigos/balrog/dragon.ogg");
