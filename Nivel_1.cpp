...
Nivel_1::Nivel_1() {
	...
	_avatar_enemigo.loadFromFile("imagenes/FondosPelea/orco.png");
	...
	life_enemy.reallife = life_personaje.reallife = 5000;
...
void Nivel_1::seleccionar_elemento() {

	_elemento.cmd();

}

void Nivel_1::seleccionar_elemento_aleatorio() {
...
void Nivel_1::cargar_textura(std::string archivo) {
	_fondos.loadFromFile(archivo);


}

void Nivel_1::cargar_sprite_fondo() {
	_fondo.setTexture(_fondos);
	_fondo.setScale(2, 2);
	
}

void Nivel_1::turno_pj() {
	_dibujar_ataque_pj = false;
...
bool Nivel_1::dibujar_elemento(){

	return _dibujar_elemento;
}

bool Nivel_1::dibujar_dado(){
	return _dibujar_dado;
}

bool Nivel_1::dibujar_ataque_pj(){
	return _dibujar_ataque_pj;
}

bool Nivel_1::dibujar_ataque_enemy(){
	return _dibujar_ataque_enemy;
}

sf::Sprite& Nivel_1::get_draw_fondo() { return _fondo; }

sf::Sprite& Nivel_1::get_draw_avatar_pj() { return _pj; }

sf::Sprite& Nivel_1::get_draw_avatar_enemigo() { return _enemigo; }

sf::Sprite& Nivel_1::get_draw_papiro() { return _papiro; }

sf::Sprite& Nivel_1::get_draw_pj(){	return _PJ.get_draw_pj(); }

sf::Sprite& Nivel_1::get_draw_enemy(){	return _enemies->getdraw(); }

sf::Sprite& Nivel_1::get_draw_life_enemy(){	return life_enemy.getdraw(); }

sf::Sprite& Nivel_1::get_draw_life_pj() { return life_personaje.getdraw(); }

sf::Sprite& Nivel_1::get_draw_elemento(){ return _elemento.getdraw(); }

sf::Sprite& Nivel_1::get_draw_dado() { return _dado.getdraw(); }

sf::Sprite& Nivel_1::get_draw_ataque_pj(){ return _Ataque.getdraw_ataque_pj(); }

sf::Sprite& Nivel_1::get_draw_ataque_enemy(){ return _Ataque.getdraw_ataque_en(); }

 
void Nivel_1::restaurar_elemento() {
...
void Nivel_1::createObject(int nivel){

		switch (nivel) {
		case 1:  this->_enemies = new orco;
			break;
		case 2: this->_enemies = new troll;
			break;
		case 3: this->_enemies = new dragon;
			break;
		case 4: this->_enemies = new balrog;
			break;
...
void Nivel_1::setDeltatime(float deltatime){
	_deltatime = deltatime;
}

void Nivel_1::cargar_sonidos_enemigos() {
